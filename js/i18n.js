...
const ES_PATTERNS = [
  ...
  [/^(\d+) of (\d+)$/, '$1 de $2'],
  [/^vs (.+) · (.+)$/, 'vs $1 · $2'],
  [/^🔥 (\d+) win streak$/, '🔥 racha de $1 victorias'],
  [/^(\d+)% win$/, '$1% victorias'],
  [/^(\d+)% score$/, '$1% de puntos'],
  [/^(\d+)% acc$/, '$1% prec'],
  [/^(\d+)% over (\d+)$/, '$1% en $2'],
  [/^#(\d+) of (\d+)$/, '#$1 de $2'],
  [/^Show more \((\d+)\) →$/, 'Ver más ($1) →'],
  [/^≈ (\d+) level$/, '≈ nivel $1'],
  [/^Rapid \((\d+)\)$/, 'Rápidas ($1)'],
  [/^Blitz \((\d+)\)$/, 'Blitz ($1)'],
  [/^Bullet \((\d+)\)$/, 'Bullet ($1)'],
  ...
  [/^· Bullet · (.+)$/, '· Bullet · $1'],
  [/^· Daily · (.+)$/, '· Por días · $1'],
  [/^engine accuracy · depth (\d+) · est\. level$/, 'precisión del motor · profundidad $1 · nivel est.'],
  [/^★ Strongest: (.+) (\d+)$/, '★ Más fuerte: $1 $2'],
  [/^⚑ Work on: (.+) (\d+)$/, '⚑ A trabajar: $1 $2'],
  [/^climbing · (.+)$/, 'subiendo · $1'],
  [/^trending up · (.+)$/, 'en alza · $1'],
  [/^sliding · (.+)$/, 'bajando · $1'],
  [/^dipping · (.+)$/, 'cayendo · $1'],
  [/^steady · (.+)$/, 'estable · $1'],
  [/^Auto-updated from (\d+) imported games \((.+)\)\. Refreshes every time you open the app\.$/, 'Actualizado con $1 partidas importadas ($2). Se actualiza cada vez que abres la app.'],
  [/^(\d+) games · (.+)$/, '$1 partidas · $2'],
];
